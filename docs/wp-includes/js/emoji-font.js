...
/*!
// Modified by Patrick Quaedackers:
//	Removed images and replaced them with
// 	WOFF font that supports colored emoji glyphs.
//	The font used is the Android font (NotoColorEmoji-Regular),
//	but any other font with emoji support works as well,
//	for example: BabelStone Flags
        ...
        while (length--) {
            ...
            while (match = re.exec(text)) {
                ...
                */
                ...
                img.style = 'font-family: emoji-font;';
                modified = true;
                fragment.appendChild(img)
    ...
    function parseString(str, options) {
        return replace(str, function(rawText) {
            /*
            	...
            	*/
            var ret = rawText;
            var ret = '<span style="font-family: emoji-font;">' + rawText + '</span>';
            return ret
        })
    }
...
// Run the parser on loading of the website
